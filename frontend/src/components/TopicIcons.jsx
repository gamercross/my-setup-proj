...
const ICONS = {
  ...
  knowledge: (
    <>
      <path d="M9 4a3 3 0 0 0-3 3v1a3 3 0 0 0-1 5.5V15a3 3 0 0 0 3 3h1" {...P} />
      <path d="M15 4a3 3 0 0 1 3 3v1a3 3 0 0 1 1 5.5V15a3 3 0 0 1-3 3h-1" {...P} />
      <path d="M9 4v14M15 4v14" {...P} />
    </>
  ),
  progress: (
    <>
