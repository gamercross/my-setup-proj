...
> 요구사항 [requirements/](requirements/) · 화면 [UI_SPEC.md](UI_SPEC.md) · 흐름 시퀀스 [DESIGN.md](DESIGN.md) §6·§7.
...
**관련 FR:** FR-PROJ-01·02·03 · **미결정:** 할일을 프로젝트에 묶을지 ([ADR-0012](adr/ADR-0012-task-project-link.md))
...
**관련 NFR:** NFR-REL-04 · **관련 ADR:** [0006](adr/ADR-0006-agent-owns-external-apis.md)(오프라인 우선)
...
**관련 FR:** FR-SYNC-01·02 · **관련 ADR:** [0008](adr/ADR-0008-supabase-deferred.md)(Week 10 이후)
