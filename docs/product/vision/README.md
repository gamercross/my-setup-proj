...
| [PERSONAL_OS.md](PERSONAL_OS.md) | Phase D 이후 방향 — 개인 생산성 OS(단일 완료·자동 분류·OKR 주간 플래너·에이전트 활동 UI) + **라이트 테마 비주얼 시스템**. 역량 테마 T1~T6, 토큰 v2, 단계 계획 P0~P12, **열린 질문 PO-1~14** | 이 방향의 작업 착수 전, "이 기능 어느 테마인가" | 참조 스크린샷의 개별 위젯 소재(주식·금은 등)는 **스타일만** 참고 — 도메인 밖. 진행 다이어그램은 [../../progress/PROGRESS.md](../../progress/PROGRESS.md) |
