...
| FR-TASK-08 | — | [ADR-0018](../architecture/adr/ADR-0018-schema-migration-strategy.md), [ADR-0029](../architecture/adr/ADR-0029-task-auto-category.md), DATA_DICTIONARY `task_tags`, API_REFERENCE `POST/DELETE /tasks/:id/tags`, UI_SPEC §3.2, requirements/TASK.md §FR-TASK-08 | 개인 OS P6 | TC-TAG-01~08, TC-DB-03/05/08a~08d, TC-SYNC-11, TC-P6-01~08, TC-AGENT-31~40/46/47 | `backend/db/schema.sql`, `backend/db/index.js` (마이그레이션), `backend/src/db.js`, `backend/src/services/tasks.js`, `backend/src/routes/tasks.js`, `agent/classify.py`, `agent/db.py`, `agent/daily_brief.py`, `frontend/src/store/taskTags.js`, `frontend/src/store/useTaskStore.js`, `frontend/src/components/TaskTags.jsx`, `frontend/src/components/TaskCard.jsx`, `frontend/src/widgets/views/TasksWidgetView.jsx` | ✅ (2026-09-08, DB 트리거 이중화 2026-09-16) — 수동 태그 + 에이전트 배치 자동 분류 |
...
| FR-UI-06 | — | [ADR-0031](../architecture/adr/ADR-0031-safe-markdown-render.md), API_REFERENCE `GET /tree`·`GET /docs/:path`, requirements/UI.md, [ADR-0013](../architecture/adr/ADR-0013-dashboard-agent-queue.md) | 개인 OS P9 | TC-DOCS-01~10, TC-TREE-01~06, TC-P9-DOC-01~02, TC-P9-REG-01, TC-P9-DEMO-01, TC-P9-M | `backend/src/services/{docs,tree}.js`, `backend/src/routes/{docs,tree}.js`, `backend/test/{docs,tree}.test.js`, `frontend/src/components/{DocView,FileTree,MermaidBlock}.jsx`, `frontend/src/widgets/views/ProgressWidgetView.jsx`, `frontend/src/widgets/docSections.js` | ✅ P9 (2026-09-08) — 구현·백엔드 테스트(TC-DOCS-*·TC-TREE-*)·ADR-0031 채택. 브라우저 수동(TC-P9-M) 로컬 대기 |
...
| FR-OKR-01~05 | — | [requirements/OKR.md](OKR.md), [ADR-0030](../architecture/adr/ADR-0030-okr-data-model.md), [ADR-0018](../architecture/adr/ADR-0018-schema-migration-strategy.md), DATA_DICTIONARY `objectives`/`key_results`/`kr_snapshots`, API_REFERENCE `/api/okr*`·`/api/planner/weekly` | 개인 OS P8 | TC-OKR-01~14, TC-PLAN-01~04 (`backend/test/okr.test.js`·`planner.test.js`), TC-DB-06 (`backend/test/db.test.js`) | `backend/db/schema.sql` (3테이블 CREATE IF NOT EXISTS), `backend/db/index.js`, `backend/src/db.js`, `backend/src/services/okr.js`(신규), `backend/src/services/planner.js`(신규), `backend/src/routes/okr.js`(신규), `backend/src/routes/planner.js`(신규), `backend/src/server.js`(기동 스냅샷), `frontend/src/api/demoClient.js`·`demoData.js`(목) | ✅ P8 (2026-09-08) — 백엔드 126/126. kr_snapshots 월별 적재는 백엔드 자체(기동+trend 진입, 일자 가드), 에이전트/launchd 미사용 |
| FR-OKR-06 | — | [requirements/OKR.md](OKR.md), [ADR-0032](../architecture/adr/ADR-0032-sidebar-shell-per-topic-layouts.md), [ADR-0027](../architecture/adr/ADR-0027-light-theme-default.md), UI_SPEC (OKR·주간 플래너 위젯), PERSONAL_OS §4 | 개인 OS P8 | TC-P8-MATH/STORE/WEEK/LINE (`frontend/test/{okrMath,okrStore,weekBuckets,linePath}.test.mjs`), TC-OKR-M·TC-PLAN-M (수동, 백로그) | `frontend/src/store/useOkrStore.js`(신규), `frontend/src/store/okrMath.js`(신규), `frontend/src/widgets/weekBuckets.js`(신규), `frontend/src/components/{LineChart.jsx,linePath.js}`(신규), `frontend/src/widgets/views/OkrWidgetView.jsx`·`PlannerWidgetView.jsx`(신규), `frontend/src/widgets/{registry,defaultLayout,widgetMeta}.js` | ✅ P8 (2026-09-08) — 프런트 98/98. Recharts 미도입(PO-8, 인라인 SVG). 실 Electron 수동확인은 백로그 |
| FR-OKR-07 | — | [requirements/OKR.md](OKR.md), [ADR-0034](../architecture/adr/ADR-0034-okr-google-grading.md), DATA_DICTIONARY `key_results.kind`, API_REFERENCE `/api/okr`·`/api/okr/key-results` | 개인 OS P8 후속 | TC-OKR-15~18 (`backend/test/okr.test.js`), TC-DB-06(확장, `backend/test/db.test.js`), TC-P8-MATH-GRADE·TC-P8-STORE-GRADE·TC-P8-DEMO-06 (`frontend/test/{okrMath,okrStore,demoClient}.test.mjs`) | `backend/db/schema.sql`(`kind` 컬럼), `backend/db/index.js`(`SCHEMA_VERSION` 2), `backend/src/db.js`, `backend/src/services/okr.js`(`krGrade`·`objectiveGrade`), `frontend/src/store/{okrMath,useOkrStore}.js`, `frontend/src/widgets/views/OkrWidgetView.jsx`, `frontend/src/api/{demoClient,demoData}.js` | ✅ 개인 OS P8 후속 (2026-09-14) |
| FR-CHECKIN-01 | — | [requirements/CHECKIN.md](CHECKIN.md), [ADR-0035](../architecture/adr/ADR-0035-expectation-checkin.md), DATA_DICTIONARY `expectation_checkins` | 개인 OS P10 | TC-CHK-01~04 (`backend/test/checkins.test.js`), TC-DB-07 (`backend/test/db.test.js`) | `backend/db/schema.sql`(`expectation_checkins` CREATE IF NOT EXISTS), `backend/src/db.js`, `backend/src/services/checkins.js`(신규), `backend/src/routes/checkins.js`(신규) | ✅ P10 (2026-09-14) |
| FR-CHECKIN-02 | — | [requirements/CHECKIN.md](CHECKIN.md), [ADR-0035](../architecture/adr/ADR-0035-expectation-checkin.md), API_REFERENCE `GET /api/checkins` | 개인 OS P10 | TC-CHK-05~06 | `backend/src/services/checkins.js`, `backend/src/db.js`(`getCheckins`) | ✅ P10 (2026-09-14) |
| FR-CHECKIN-03 | — | [requirements/CHECKIN.md](CHECKIN.md), [ADR-0035](../architecture/adr/ADR-0035-expectation-checkin.md), API_REFERENCE `PUT/DELETE /api/checkins/:id` | 개인 OS P10 | TC-CHK-07~09 | `backend/src/services/checkins.js`, `backend/src/db.js`(`updateCheckin`·`deleteCheckin`) | ✅ P10 (2026-09-14) |
| FR-CHECKIN-04 | — | [requirements/CHECKIN.md](CHECKIN.md), [ADR-0032](../architecture/adr/ADR-0032-sidebar-shell-per-topic-layouts.md), UI_SPEC (기대정렬 위젯) | 개인 OS P10 | TC-P10-REG-01, TC-P10-STORE-01~04, TC-P10-DEMO-01 (`frontend/test/{registry,checkinStore,demoClient}.test.mjs`) | `frontend/src/store/useCheckinStore.js`(신규), `frontend/src/widgets/views/CheckinWidgetView.jsx`(신규), `frontend/src/widgets/{registry,defaultLayout,widgetMeta,topics}.js`, `frontend/src/components/TopicIcons.jsx` | ✅ P10 (2026-09-14) — 브라우저 수동 로컬 대기 |
| FR-CHECKIN-05 | — | [requirements/CHECKIN.md](CHECKIN.md), [ADR-0035](../architecture/adr/ADR-0035-expectation-checkin.md), [ADR-0012](../architecture/adr/ADR-0012-task-project-link.md)(느슨 FK 관례) | 개인 OS P10 | TC-CHK-04, TC-CHK-06, TC-DB-07 | `backend/db/schema.sql`(`ON DELETE SET NULL`), `backend/src/services/checkins.js` | ✅ P10 (2026-09-14) |
| FR-KNOW-01 | — | [requirements/KNOWLEDGE.md](KNOWLEDGE.md), [ADR-0036](../architecture/adr/ADR-0036-knowledge-trend-view.md), API_REFERENCE `GET /api/knowledge-trend` | 개인 OS P11 | TC-KNOW-01~08 (`backend/test/knowledgeTrend.test.js`) | `backend/src/db.js`(`getCheckinCountsByWeek`·`getTagCountsInRange`·`getKrTrendFrom`), `backend/src/services/knowledgeTrend.js`(신규), `backend/src/routes/knowledgeTrend.js`(신규) | ✅ P11 (2026-09-15) |
| FR-KNOW-02 | — | [requirements/KNOWLEDGE.md](KNOWLEDGE.md), [ADR-0032](../architecture/adr/ADR-0032-sidebar-shell-per-topic-layouts.md), UI_SPEC (지식 지도 위젯) | 개인 OS P11 | TC-P11-REG-01, TC-P11-STORE-01~03, TC-P11-LINE-01~02 (`frontend/test/{registry,knowledgeStore,linePath}.test.mjs`) | `frontend/src/store/useKnowledgeStore.js`(신규), `frontend/src/widgets/views/KnowledgeWidgetView.jsx`(신규), `frontend/src/components/{LineChart.jsx,linePath.js}`(하위 호환 확장), `frontend/src/widgets/{registry,defaultLayout,widgetMeta,topics}.js`, `frontend/src/components/TopicIcons.jsx` | ✅ P11 (2026-09-15) — 브라우저 수동 로컬 대기 |
| FR-KNOW-03 | — | [requirements/KNOWLEDGE.md](KNOWLEDGE.md), [ADR-0026](../architecture/adr/ADR-0026-web-demo-mode.md) | 개인 OS P11 | TC-P11-DEMO-01, TC-PARITY-02 (`frontend/test/demoClient.test.mjs`), `scripts/check-demo-parity.mjs` | `frontend/src/api/demoClient.js`(`knowledgeTrend()`, `DEMO_ROUTES`) | ✅ P11 (2026-09-15) |
| FR-KNOW-04 | — | [requirements/KNOWLEDGE.md](KNOWLEDGE.md), `docs/REVERSE_PLAN.md` §5·§5-3 | 개인 OS P11 | — (문서 검토) | `docs/REVERSE_PLAN.md` | ✅ P11 (2026-09-15) |
| FR-REF-01 | — | [requirements/REFERENCE.md](REFERENCE.md), [ADR-0037](../architecture/adr/ADR-0037-reference-summary-tracking.md), DATA_DICTIONARY `reference_materials` | 개인 OS P12 | TC-REF-01~05, TC-REF-12 (`backend/test/references.test.js`) | `backend/db/schema.sql`(`reference_materials`·`reference_summary_steps` CREATE IF NOT EXISTS), `backend/src/db.js`, `backend/src/services/references.js`(신규), `backend/src/routes/references.js`(신규) | ✅ P12 (2026-09-15) |
| FR-REF-02 | — | [requirements/REFERENCE.md](REFERENCE.md), [ADR-0037](../architecture/adr/ADR-0037-reference-summary-tracking.md), API_REFERENCE `GET /api/references` | 개인 OS P12 | TC-REF-06~07 | `backend/src/services/references.js`, `backend/src/db.js`(`getReferences`) | ✅ P12 (2026-09-15) |
| FR-REF-03 | — | [requirements/REFERENCE.md](REFERENCE.md), [ADR-0037](../architecture/adr/ADR-0037-reference-summary-tracking.md), API_REFERENCE `PUT/DELETE /api/references/:id` | 개인 OS P12 | TC-REF-08~09 | `backend/src/services/references.js`, `backend/src/db.js`(`updateReference`·`deleteReference`) | ✅ P12 (2026-09-15) |
| FR-REF-04 | — | [requirements/REFERENCE.md](REFERENCE.md), [ADR-0037](../architecture/adr/ADR-0037-reference-summary-tracking.md) §결정3·4, API_REFERENCE `POST/DELETE .../steps` | 개인 OS P12 | TC-REF-10~11 | `backend/src/db.js`(`attachSteps`·`addReferenceStep`·`removeReferenceStep`), `backend/src/services/references.js`(`addStep`·`removeStep`) | ✅ P12 (2026-09-15) |
| FR-REF-05 | — | [requirements/REFERENCE.md](REFERENCE.md), [ADR-0032](../architecture/adr/ADR-0032-sidebar-shell-per-topic-layouts.md), UI_SPEC (레퍼런스 위젯) | 개인 OS P12 | TC-P12-REG-01, TC-P12-STORE-01~05, TC-P12-DEMO-01~02 (`frontend/test/{registry,referenceStore,demoClient}.test.mjs`) | `frontend/src/store/useReferenceStore.js`(신규), `frontend/src/widgets/views/ReferenceWidgetView.jsx`(신규), `frontend/src/widgets/{registry,defaultLayout,widgetMeta,topics}.js`, `frontend/src/components/TopicIcons.jsx` | ✅ P12 (2026-09-15) — 브라우저 수동 로컬 대기 |
| FR-REF-06 | — | [requirements/REFERENCE.md](REFERENCE.md), [ADR-0037](../architecture/adr/ADR-0037-reference-summary-tracking.md), [ADR-0012](../architecture/adr/ADR-0012-task-project-link.md)(느슨 FK 관례) | 개인 OS P12 | TC-REF-05, TC-REF-07 | `backend/db/schema.sql`(`ON DELETE SET NULL`), `backend/src/services/references.js` | ✅ P12 (2026-09-15) |
...
| [ADR-0030](../architecture/adr/ADR-0030-okr-data-model.md) OKR 데이터 모델 | FR-OKR-01~06 | ✅ 채택 (2026-09-08, PO-5/6) — 1급 엔티티 3테이블, 주간 플래너 순수 집계. 구현 완료 개인 OS P8 (2026-09-08). 요구사항 [OKR.md](OKR.md) |
| [ADR-0031](../architecture/adr/ADR-0031-safe-markdown-render.md) 안전 마크다운 렌더 + 파일 트리 API | FR-UI-06 | ✅ 채택 (2026-09-08, PO-11·PO-12) + P9 구현 — `GET /api/tree`·`GET /api/docs/:path`(`services/{tree,docs}.js` 의존성 0 토크나이저) + `DocView.jsx`(파서·`dangerouslySetInnerHTML` 없음) + `progress` 위젯(좌 트리/우 본문, 분할선 드래그·패널 접기). prod `docs/` 동봉은 Phase E3 이월 — 미동봉 시 빈 트리 200 |
...
| [ADR-0034](../architecture/adr/ADR-0034-okr-google-grading.md) OKR 구글식 등급 | FR-OKR-02/03/07 | ✅ 채택 (2026-09-14) — `key_results.kind`(committed/aspirational) + `krGrade`/`objectiveGrade` 등급 밴드. 요구사항 [OKR.md](OKR.md) FR-OKR-07 |
| [ADR-0035](../architecture/adr/ADR-0035-expectation-checkin.md) 기대정렬 체크인 | FR-CHECKIN-01~05 | ✅ 채택 (2026-09-14) — 전용 테이블 1개(`expectation_checkins`), 7질문 자유 서술, `SCHEMA_VERSION` 미상향. 요구사항 [CHECKIN.md](CHECKIN.md) |
| [ADR-0036](../architecture/adr/ADR-0036-knowledge-trend-view.md) 지식 축적 추세·역량 지도 | FR-KNOW-01~04 | ✅ 채택 (2026-09-15) — 읽기 전용 파생 뷰, 새 테이블 없음, 체크인(주)·OKR(월) 비대칭 유지, `kr_snapshots` 미적재. 요구사항 [KNOWLEDGE.md](KNOWLEDGE.md) |
| [ADR-0037](../architecture/adr/ADR-0037-reference-summary-tracking.md) 레퍼런스 자료 요약 절차 추적 | FR-REF-01~06 | ✅ 채택 (2026-09-15) — 부모-자식 2테이블(`reference_materials`+`reference_summary_steps`), 요약 단계는 추가·삭제만(수정 없음, 재번호 안 함), `SCHEMA_VERSION` 미상향. 요구사항 [REFERENCE.md](REFERENCE.md) |
