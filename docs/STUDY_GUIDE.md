...
| Week 4 (화면 착수 전) | 대시보드 정보 설계, ARIA 패턴, 다크 테마 대비, 디자인 토큰 계층 (§2.9) | [UI_STYLE.md](product/reference/UI_STYLE.md) 캡처 5장 채우기 → US-1(강조색) 결정 → [UI_SPEC.md](product/reference/UI_SPEC.md) §1 토큰 반영 |
