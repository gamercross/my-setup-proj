...
| **C** | AITool기반소프트웨어공학 (유승선) | **정통 SW공학 산출물** | `docs/product/` 전체 — FR/NFR, [ARCHITECTURE.md](../product/architecture/ARCHITECTURE.md) §0(C4/arc42), ADR 0001~0037, [TRACEABILITY.md](../product/requirements/TRACEABILITY.md), [TEST_PLAN.md](../product/testing/TEST_PLAN.md), [DESIGN.md](../product/architecture/DESIGN.md), mermaid(UML 대체) |
