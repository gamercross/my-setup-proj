...
```mermaid
flowchart TB
  W13["Week 1~3 · Linux 기초"] --> A13["App 폴더 구조 · 파일 관리 실습"]
  W4["Week 4 · Node.JS"] --> A4["Electron + React 앱 · 첫 화면"]
  W5["Week 5 · SQLite"] --> A5["DB 테이블 설계 · 로컬 저장소"]
  W6["Week 6 · 프로세스 관리"] --> A6["서버/에이전트 백그라운드 · Cron 스케줄"]
  W7["Week 7 · 패키지/압축"] --> A7["배포 준비 (Docker) · 백업"]
  W8["Week 8 · 중간고사 + 과제 1"] --> A8{{"반쯤 완성된 프로젝트 발표"}}
  W911["Week 9~11 · 고급 주제"] --> A911["사용자 관리 · 네트워크 · <b>Claude 에이전트</b>"]
  W1213["Week 12~13 · 배포/최적화"] --> A1213["Docker 배포 · 보안 · 성능"]
  W1415["Week 14~15 · 기말 + 과제 2"] --> A1415{{"완성 프로젝트 최종 발표"}}

  A13 --> W4 --> W5 --> W6 --> W7 --> W8 --> W911 --> W1213 --> W1415
```
