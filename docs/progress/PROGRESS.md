...
| 다음 | ⏳ | **앱 통합** (PERSONAL_OS §4-3 — 통합 실행 스크립트 `bash scripts/dev.sh` ✅ ADR-0016 1항 채택 2026-09-09; 데모↔실서버 경로 패리티 ✅; 남은 것 ADR-0016 2~4항) + P7·P8·P9·P10 로컬 수동 검증 백로그(TC-ACT-M/TC-AGENT-M, TC-OKR-M/TC-PLAN-M, TC-P9-M, TC-DEV-M1~3) |
